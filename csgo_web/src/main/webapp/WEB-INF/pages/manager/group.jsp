...
<%@ page contentType="text/html;charset=UTF-8" language="java" isELIgnored="false" %>
    ...
    <head>
        ...
        <script>
            ...
            function eventt(){
                var groupaid = document.getElementById("groupaid").value;
                var groupbid = document.getElementById("groupbid").value;
                var message = document.getElementById("message").value;
                if(groupaid.length == 0 || groupaid =="" || groupbid.length == 0 || groupbid ==""){
                    alert("请填全信息");
                }else{
                    var obj ={
                        groupaid:groupaid,
        ...
        <div class="row">
            <div class="col-md-2">
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="id" placeholder="组号id">
                    <br>
            ...
            <div class="col-md-4">
                <div class="row">
                    ...
                    <div class="col-md-6" style="padding-left: 0%;padding-top: 0%;padding-bottom: 0%;">
                        ...
                        <input type="text" class="form-control" id="id2" placeholder="组号id">
                        <br>
                        <button type="button" class="btn btn-info" onclick="modify()" id="btn1">提交修改</button>
                    </div>
                    <div class="col-md-6">
                    <label for="groupname">队名</label>
                    <input type="text" class="form-control" id="groupname" placeholder="队名">
                </div>
            </div>
        </div>
    </div>
    <div class="container">
        <div class="row">
            ...
            <div class="col-md-1">
                <div class="form-group">
                    <label>A队ID</label>
                    <input type="text" class="form-control" id="groupaid" placeholder="Aid">
                </div>
            </div>
            <div class="col-md-1">
                <div class="form-group">
                    <label>B队ID</label>
                    <input type="text" class="form-control" id="groupbid" placeholder="Bid">
                </div>
            </div>
            <div class="col-md-5">
                <div class="form-group">
                    <label>备注</label>
                    <input type="email" class="form-control" id="message" placeholder="备注">
                </div>
            </div>
            <div class="col-md-1">
                <label>歪比歪比</label>
                <button type="button" class="btn btn-info" onclick="eventt()">提交赛事</button>
            </div>
        </div>
    </div>
